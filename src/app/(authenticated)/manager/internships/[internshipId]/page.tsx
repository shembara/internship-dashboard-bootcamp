...
export default async function AssignmentDetailPage({
  ...
  return (
    <section className="mx-auto max-w-6xl space-y-7">
      ...
      <section className="rounded-2xl border border-white/[0.08] bg-[#121a20] p-5 shadow-sm">
          ...
          {assignments.length ? (
            <div className="space-y-3">
              {assignments.map((assignment) => (
                <article
                  key={assignment.id}
                  className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-white/[0.08] bg-[#121a20] p-4"
                >
                  <div className="grow">
          ...
          {detail.statusHistory.length ? (
            <ul className="space-y-3">
              {detail.statusHistory.map((entry) => (
                <li
                  key={entry.id}
                  className="rounded-xl border border-white/[0.08] bg-[#121a20] p-4 text-sm"
                >
