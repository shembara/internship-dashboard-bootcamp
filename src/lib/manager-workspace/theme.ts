...
export function workspaceStyles(variant: WorkspaceVariant = "default") {
  ...
  return {
    ...
    input: "rounded-lg border bg-background px-3 py-2 text-sm outline-none focus:border-[var(--brand)]",
    textarea:
    ...
    dashedPlaceholder: "rounded-xl border border-dashed p-6 text-sm text-muted-foreground",
